#include <stdio.h> // Thêm thư viện stdio.h để sử dụng hàm nhập xuất dữ liệu.
...
int main() {
    ...
    float x = giaithua(1); // Khởi tạo biến x bằng giai thừa của 1 (1!).
    ...
    printf("sum = %.5f", x); // In ra giá trị của x với 5 chữ số sau dấu thập phân.

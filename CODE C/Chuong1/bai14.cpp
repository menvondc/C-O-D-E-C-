...
int main() {
    ...
    printf("Nhap x: "); // Yêu cầu người dùng nhập giá trị của x.
    scanf("%d", &x); // Nhận giá trị của x từ người dùng.
    
    for (int i = 1; i <= n; i += 2) { // Vòng lặp từ i=1 đến i=n, tăng i lên 2 mỗi lần lặp để chỉ tính lũy thừa của các số lẻ.
